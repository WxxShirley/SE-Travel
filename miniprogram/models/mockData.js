...
var shares = [
  ...
  {imgSrc: "../../images/waterfall/1.jpeg", content: "超简略迪士尼攻略🐮 推荐项目：创极速光轮＞飞跃地平线＞小矮人矿车＞加勒比海盗（这四个一定要玩）。游玩路线：我玩的是逆时针，一上午几乎刷完了想玩的项目 。烟花表演：晚上20点30开始，建议19点去米奇大街占位置。吃喝购物：建议都在迪士尼小镇解决", user_avatar: "../../images/userAvater/9.jpeg", like: 20, amILike: true},
  {imgSrc: "../../images/waterfall/2.jpeg", content: "故宫不得不去的地方！第一，故宫中轴线上的前殿，那个气势恢宏，那个雄伟壮阔，再租个讲解器听一听，这些建筑在古代到底是怎样的呢？一定会让你对于故宫有一个更深刻的印象！第二，珍宝馆，珍宝馆是需要再收10块钱门票的，但是这个景点那是非常的值，她的范围大概是皇极殿（一个乾隆本来想修建给退位后的自己住的，但是他一天也没住的地方），里面包括很多很多大家耳熟能详的故宫打卡地点，eg，九龙壁、珍妃井、还有各种金银器珠宝的地方，所以一定要去！！！然后就是一些在我心中排名不分先后的地方啦，比如男生可能更爱的箭亭（里面有镶了宝石皇上用过的马鞍、弓箭等武器）；电视剧迷都要去的延禧宫（延禧攻略，延禧宫现在还有AR技术）、翊坤宫（甄嬛传，但是被慈禧把翊坤宫和储秀宫给打通了）；历史控要去的储秀宫（那些个展品啊）、钟宝馆（那些个中式、西式、会动的、不会动的计时器）等等等。怎么说呢，故宫在我心中就是一个大宝藏！怎么挖都挖不光！", user_avatar: "../../images/userAvater/9.jpeg", like: 32, amILike: true},
  {imgSrc: "../../images/waterfall/3.jpeg", content: "成都小吃推荐！麻辣兔头：麻辣兔头是成都的特色名小吃，特别是双流兔头，速冻的鲜兔头加上麻辣鲜香的干辣椒，鲜香味美，口感极佳，让人狂流口水系列！。凉糕：凉糕是锦里的一大特色，利用糖、豆沙、江米等材料做成的糕点冰起来，再切块就成了糯米凉糕。而且这里还有特别的麻辣口味，真是有意思~  叶儿粑：叶儿粑又叫艾馍，是四川名小吃之一，因为外面包有良姜叶子，所以又叫叶儿粑。滚烫之时，一口咬下去，油汁“滋滋”往外冒，满嘴肉香，别提让人多满足！牛肉焦饼：牛肉焦饼是一种馅饼，不过在川味的调教下，牛肉焦饼变得又酥又嫩，非常好吃，吃的时候再配一口鲜香浓郁的牛肉汤，用成都话说，简直巴适得板！", user_avatar: "../../images/userAvater/9.jpeg", like: 999, amILike: false},
  {imgSrc: "../../images/waterfall/1.jpeg", content: "😄 野人版 - 上海欢乐谷🌈游玩攻略🌟: 进门右转去 异度空间（鬼屋）——天地双雄——摇摆伞——欢乐风火轮——魔幻陀螺——谷木游龙——绝地雄风——飞旋驼峰——峡谷漂流——蓝月飞车——大洋历险——矿山历险——金银岛——激流勇进——极速旋风——完美风暴——天幕水极（晚上）——旋转木马——返程。一圈下来该玩的都玩了，入园之后建议先去玩大型项目就去玩，越到后面排队时间越久。 ", user_avatar: "../../images/userAvater/10.jpeg", like: 13, amILike: true},
  {imgSrc: "../../images/waterfall/2.jpeg", content: "蔓越阑珊｜蔓越莓➕奶油➕果茶带着一点酸味的果味奶 配上沾点蔓越莓的奶油 很特别 但完全不难喝 是👦🏻喝的我只尝了下喜奶的可以尝试", user_avatar: "../../images/userAvater/9.jpeg", like: 5, amILike: true},
  {imgSrc: "../../images/waterfall/3.jpeg", content: "🌈 一条开挂版的故宫游览路线：上午门城墙→经过 东华门→神武门城墙下来。这条路线，能够俯瞰故宫，居高临下。如果天气好，还可以看见远处的西山。（现在这条路线人还不太多）", user_avatar: "../../images/userAvater/10.jpeg", like: 20, amILike: false},
  {imgSrc: "../../images/waterfall/1.jpeg", content: "逻辑吧嗦半游记性质的攻略: Day1 南京站 鸡鸣寺 明城墙 玄武湖 青旅 总统府 凯瑟琳广场 狮子桥 颐和路 南京大学 先锋书店 明瓦廊。Day2 老门东 南京博物馆 钟山风景区 夫子庙-秦淮河一带。真正到了南京我才发现，旅行的意义不在于一份完美的攻略，而在于当你真正行走于这座城市，它的气场契合于你，带给你无可复制的体验，于是这趟旅途中的遗憾也化成了更多的期待。南京太太太美好了，我还没爬到城墙上俯瞰南京，还没数过中山陵的台阶....这些遗憾都是我下次去南京的理由～", user_avatar: "../../images/userAvater/10.jpeg", like: 20, amILike: false},
